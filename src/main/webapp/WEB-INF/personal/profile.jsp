        ...
        <div id="base_content" style="margin-top: 40px;margin-left: 60px;font-size: 18px;" >
            ...
            <div>
                <form id="userInfo_form" action="${ctx}/saveUserInfo" method="post">
                    ...
                    生日： <input  style="width: 198px;float: right;margin-right: 484px;margin-top: -4px" class="form-control form-date"  readonly="readonly" placeholder="选择一个日期：yyyy-MM-dd" type="text" id="txtEndDate"  name="birthday" value="${userInfo.birthday==null?"":userInfo.birthday}"/><br/><br/>
